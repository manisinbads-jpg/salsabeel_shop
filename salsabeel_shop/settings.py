"""
Django settings for salsabeel_shop project.
...
ROOT_URLCONF = 'salsabeel_shop.urls'
...
WSGI_APPLICATION = 'salsabeel_shop.wsgi.application'
...
DEFAULT_FROM_EMAIL = 'no-reply@salsabeel.com'
